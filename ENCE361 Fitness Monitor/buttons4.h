...
#define UP_BUT_INT_PIN  GPIO_INT_PIN_0
...
#define RIGHT_BUT_INT_PIN  GPIO_INT_PIN_0
...
//interrupt handler
void UP_BUTPortEIntHandler();
void DOWN_BUTPortDIntHandler();
void L_BUTPortFIntHandler();
void R_BUTPortFIntHandler();
...
//flag
bool downHoldFlag; // flag for long press down button
//counter
int16_t downHoldCounter;
